...
from books.models import BookInstance, Book, Genre, Language
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        for book_copy in range(number_of_book_copies):
            ...
            borrowed_date = timezone.now() + datetime.timedelta(days=book_copy % 5)
            if book_copy % 2:
            ...
            BookInstance.objects.create(book=test_book, imprint='Unlikely Imprint, 2016', due_back=return_date,
                                        borrower=the_borrower, status=status, borrowed=borrowed_date)

    def test_redirect_if_not_logged_in(self):
        response = self.client.get(reverse('my-borrowed'))
        self.assertRedirects(
            response, '/accounts/login/?next=/books/mybooks/')
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(
            response, 'books/bookinstance_list_borrowed_user.html')
